...
import com.toedter.calendar.JDateChooser;import java.awt.Dimension;
public class IssueBook extends javax.swing.JFrame {

   private JDateChooser issueChooser;
    private JDateChooser dueChooser;
    public IssueBook() {
        initComponents();
        issueChooser = new JDateChooser();
        issueChooser.setDateFormatString("dd-MM-yyyy");
        issueChooser.setPreferredSize(new Dimension(260, 40));
        
        dueChooser = new JDateChooser();
        dueChooser.setDateFormatString("dd-MM-yyyy");
        dueChooser.setPreferredSize(new Dimension(260, 40));
        
        // Add the components to the frame at the correct positions
    ...
    String issueD = "";
    if (issueChooser.getDate() != null) {
        issueD = dForm.format(issueChooser.getDate());
    }
    
    String dueD = "";
    if (dueChooser.getDate() != null) {
        dueD = dForm.format(dueChooser.getDate());
    }
